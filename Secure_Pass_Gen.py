...
def save1():
    """Saved Password/s"""
    random_password = entry.get()
    savedPassword = random_password
    
    """Append given text as a new line to the end of the file"""
    # open the file in append and read mode ('a+')
    with open("savedPasswords.txt", 'a+') as file_object:
        ...
        file_object.write(savedPassword)
...
save_button = Button(root, text="Save Pass", command=save1)
